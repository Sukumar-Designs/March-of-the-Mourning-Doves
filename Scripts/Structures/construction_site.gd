...
@onready var range_tower_1 = load("res://Assets/Terrain/Pine_Tree.glb") 
@onready var range_tower_2 = load("res://Full_Assets/Terrain/tree_full.tscn")
@onready var bridge = load("res://Full_Assets/Structures/Bridge_Full.tscn")
