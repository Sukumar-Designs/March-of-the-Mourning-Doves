...
@onready var inventory_items_scenes = {
	"sub_type_twig":preload("res://Full_Assets/Terrain/Twig_Full.tscn"),
	"sub_type_acorn":preload("res://Full_Assets/Terrain/Twig_Full.tscn"),
	"sub_type_pebble":preload("res://Full_Assets/Terrain/Twig_Full.tscn"),
	"sub_type_seed":preload("res://Full_Assets/Terrain/Twig_Full.tscn")
}
