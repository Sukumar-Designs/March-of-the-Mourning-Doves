...
# Building Types
@onready var base_preview = load("res://Assets/Terrain/Mushroom.glb") 
@onready var base = load("res://Full_Assets/Structures/bird_base_full.tscn")
@onready var range_tower_1_preview = load("res://Assets/Terrain/Pine_Tree.glb") 
@onready var range_tower_1 = load("res://Full_Assets/Terrain/tree_full.tscn")
@onready var bridge_preview = load("res://Assets/Structures/bridge/bridge.tscn")
@onready var bridge = load("res://Full_Assets/Sturcutres/Bridge_Full.tscn")


@onready var construction = load("res://Full_Assets/Structures/Construction_Site_Full.tscn")
